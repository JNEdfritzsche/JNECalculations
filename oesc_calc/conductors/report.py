...
COND_SCHEDULE_SPEC = ReportSpec(
    ...
    cols=[
        ...
        Column("Conductor form", lambda r: get_first(r, "conductor_form", default="—")),
        ...
        Column("Design current (A)", lambda r: fmt(get_first(r, "I_design_total"), "A")),
        Column("Parallel sets", lambda r: get_first(r, "n_parallel", default="—")),
        Column("Per set (A)", lambda r: fmt(get_first(r, "I_per_set"), "A")),
        Column("k_corr", lambda r: _factor(r, "corr_factor", "corr_factor_source")),
        Column("k_temp", lambda r: _factor(r, "temp_factor", "temp_factor_source")),
        Column("k_total", lambda r: fmt(get_first(r, "k_total"))),
        Column("Required base (A)", lambda r: fmt(get_first(r, "I_table_required"), "A")),
        Column("Ampacity table", _table_column),
        Column("Conductor Size", _size, color="blue"),
        Column("Base ampacity (A)", lambda r: fmt(get_first(r, "base_ampacity"), "A")),
        Column("Adjusted per set (A)", lambda r: fmt(get_first(r, "adjusted_ampacity_per_set"), "A"), color="green"),
