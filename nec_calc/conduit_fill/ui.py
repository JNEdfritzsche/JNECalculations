...
from nec_calc.conduit_fill.report import render_export_report
...
def render_calc():
    ...
    units_choice = st.radio(
        ...
        horizontal=True,
        key="cfn_units",
        help="NEC Chapter 9 tables publish both unit systems; values are read directly from the matching table columns.",
    )
