...
CT_SCHEDULE_SPEC = ReportSpec(
    ...
    cols=[
        ...
        Column("Tray type", _tray_type),
        Column("Tray width", lambda r: fmt(get_first(r, "tray_width"), _length_unit(r))),
        Column("No. of cables", lambda r: get_first(r, "n_cables", default="—")),
        Column("Total cable area", lambda r: fmt(get_first(r, "total_cable_area"), _area_unit(r))),
        Column("Sum of diameters", lambda r: fmt(get_first(r, "sum_diameters"), _length_unit(r))),
        Column("Governing rule", lambda r: get_first(r, "rule", default="—")),
        Column("Limited by", _basis),
        Column("Value checked", lambda r: fmt(get_first(r, "limited_value"), _basis_unit(r))),
        Column("Allowed", lambda r: fmt(get_first(r, "allowed_value"), _basis_unit(r))),
        Column("Sd", lambda r: fmt(get_first(r, "sd"), _length_unit(r))),
        Column("Utilization (%)", lambda r: fmt(get_first(r, "utilization_percent"), "%"), color="green"),
        Column("Fits?", lambda r: yes_no(get_first(r, "fits"))),
        Column("Single layer", lambda r: yes_no(get_first(r, "single_layer"))),
        Column("Min tray width", lambda r: fmt(get_first(r, "min_tray_width"), _length_unit(r)), color="blue"),
