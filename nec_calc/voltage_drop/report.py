...
VD_SCHEDULE_SPEC = ReportSpec(
    ...
    cols=[
        ...
        Column("Conduit", _conduit, group="conductor"),
        Column("From table (Ω/kft)", _table_value, result=True, group="rz"),
        Column("R/Z used (Ω/kft)", _rz, result=True, group="rz"),
    ...
    groups={
        "conductor": Group("Material / conduit"),
        "rz": Group("R/Z from table → used (Ω/kft)", " → "),
    },
